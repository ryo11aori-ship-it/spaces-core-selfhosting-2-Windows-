...
def build_dummy_pe():
    ...
    w32(0x194, 0xC0000040) # Characteristics (Initialized Data, Read, Write)
    ...
    code = [
        ...
        0xFF, 0x15, 0x2D, 0x10, 0x00, 0x00,             # call [rip + 0x102D] (IAT: WriteFile)
        
        # ExitProcess(0)
        0x31, 0xC9,                                     # xor ecx, ecx
        0xFF, 0x15, 0x2D, 0x10, 0x00, 0x00              # call [rip + 0x102D] (IAT: ExitProcess)
    ]
